...
class ArUcoTracker:
    def __init__(self, camera_id=0, width=1280, height=720, fps=30,
        ...
        self.parameters = aruco.DetectorParameters(
            aruco.DetectorParameters() 追加(2026/3/30)
            if hasattr(aruco, "DetectorParameters") 追加(2026/3/30)
            else aruco.DetectorParameters_create() 追加(2026/3/30)
        )
        self.detector = (
            aruco.ArucoDetector(self.aruco_dict, self.parameters)
            if hasattr(aruco, "ArucoDetector") 追加(2026/3/30)
            else None 追加(2026/3/30)
        )
        self.cap = None
        self.dev = None
        self.init_motor()
